...
<p align="center">기존 MySql에서 검색하였을 때보다 약 7배 향상된 검색 성능을 보였습니다.</p>
...
<p align="center">
처음 기획은 자연어를 학습 된 GPT를 통해 Qurey 명령어로 변환하려고 하였습니다.  </br>
비용 문제와 데이터베이스 종류 교체로 검색어 변환 방식을 교체했습니다. </br> 
...
<p align="center">
이를 해결하기 위해 모든 파일을 토큰 단위로 쪼개어 저장하였습니다.  </br>
초기에는 500 토큰 단위로 분할하였으나 응답이 부정확하였습니다.  </br>
...
<p align="center">Query 벡터와 유사한 상위 4개의 벡터를 Vector DB에서 추출하여 GPT에게 전송함으로써 토큰 제한 문제를 해결했습니다.</p>
